...
THREE.Water = function ( geometry, options ) {
	...
	var normalMap0 = options.normalMap0 || textureLoader.load( '/textures/waternormals.jpg' );
	var normalMap1 = options.normalMap1 || textureLoader.load( '/textures/waternormals.jpg' );
